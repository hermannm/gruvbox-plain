...
public abstract class BaseColorSettingsPage internal constructor() : ColorSettingsPage {
...
private val ADDITIONAL_HIGHLIGHTING_TAG_TO_DESCRIPTOR_MAP: Map<String, TextAttributesKey> =
    mapOf(
